...
const Transactions: React.FC = () => {
  ...
  const exportToPDF = () => {
    ...
    for (let i = 1; i <= pageCount; i++) {
      ...
      doc.text(`Extrato Flowy ERP • Página ${i} de ${pageCount} • Gerado em ${now.toLocaleDateString('pt-BR')}`, pageWidth / 2, pageHeight - 10, { align: 'center' });
    }
  ...
  const handleExportExcel = () => {
    ...
    exportToExcel(dataToExport, 'Transacoes_Flowy');
