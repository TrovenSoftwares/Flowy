            ...
            <form id="edit-form" onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <InputMask
                        ...
                        leftIcon={<span className="text-slate-400 text-sm font-bold">R$</span>}
                    />
                    <Input
                        label="Data"
                        type="date"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-1.5">
                        <label className="text-sm font-medium text-slate-700 dark:text-slate-300">Conta</label>
                        <CustomSelect
                ...
                {/* Contact */}
                <div className="space-y-1.5">
                    <label className="text-sm font-medium text-slate-700 dark:text-slate-300">{formData.type === 'income' ? 'Cliente' : 'Fornecedor / Funcionário'}</label>
                    <CustomSelect
